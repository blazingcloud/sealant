//
//  TestFlight.h
//  Stub to replace log with macro
//  same @interface TestFlight as in original TestFlight.h
//
//  Original Created by Jonathan Janzen on 06/11/11.
//  Copyright 2011 TestFlight. All rights reserved.

#define TESTFLIGHT_SDK_VERSION @"mock"

#undef TFLog
#ifdef DEBUG
#	define TFLog(fmt, ...) DLog(fmt, ##__VA_ARGS__);
#endif
